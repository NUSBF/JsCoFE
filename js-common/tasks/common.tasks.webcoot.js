...
function TaskWebCoot()  {
  ...
  this.input_dtypes = [{        // input data types
      data_type   : {'DataRevision' :[['xyz','phases']],
                     'DataStructure':[['xyz','phases']],
                     'DataXYZ'      :[],
                     'DataEnsemble' :[],
                     'DataModel'    :[]
                    }, // data type(s) and subtype(s)
      label       : 'Structure revision<br>or model', // label for input dialog
      ...
      data_type   : {'DataStructure':[['xyz','phases']],
                     'DataEnsemble' :[],
                     'DataModel'    :[],
                     'DataXYZ'      :[]
                    },  // data type(s) and subtype(s)
