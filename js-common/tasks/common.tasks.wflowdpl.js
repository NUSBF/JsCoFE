...
TaskWFlowDPL.prototype.clipboard_name = function()  { return '"Dimple refinement Workflow"'; }

TaskWFlowDPL.prototype.desc_title     = function()  {
  return 'Dimple pipeline, ligand fitting, refinement and PDB validation report';
}

//TaskWFlowDPL.prototype.canRunInAutoMode = function() { return true; }
