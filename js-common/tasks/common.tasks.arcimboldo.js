...
function TaskArcimboldo()  {
  ...
  this.name   = 'arcimboldo';
  this.setOName ( 'arcimboldo' );  // default output file name template
  this.title  = 'Fragment Molecular Replacement with Arcimboldo';
...
if (__template)
      TaskArcimboldo.prototype = Object.create ( __template.TaskTemplate.prototype );
else  TaskArcimboldo.prototype = Object.create ( TaskTemplate.prototype );
...
TaskArcimboldo.prototype.icon = function()  { return 'task_arcimboldo'; }
//TaskArcimboldo.prototype.requiredEnvironment = function() { return ['CCP4','ROSETTA_DIR']; }

TaskArcimboldo.prototype.currentVersion = function()  {
  var version = 0;
  if (__template)
...
if (__template)  {
  ...
  TaskArcimboldo.prototype.makeInputData = function ( loginData,jobDir )  {
  ...
  TaskArcimboldo.prototype.getCommandLine = function ( jobManager,jobDir )  {
