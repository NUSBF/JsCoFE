...
def put_iris_section ( body,revision ):
    ...
    try:
        ...
        body.putMessage1 ( sec_id,"<h3>There were errors</h3>" +\
                           "<i>Iris failed, check messages in Errors tab.</i>" +\
                           "<p>&nbsp;",
                           0,col=0 )
    ...
    if revision:
        ...
        try:
            ...
            if (refmacResults):
                ...
                if (meta and "natoms_overall" in meta.keys()):
            ...
            body.putMessage1 ( reportPanelId,"<h3>There were errors</h3>" +
                                             "<i>Table 1 could not be generated because of errors</i>",1,col=0 )
            return
