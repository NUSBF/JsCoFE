...
function LoginPage ( sceneId )  {
  ...
  panel.setVerticalAlignment    ( row  ,col,'middle' );
  panel.setVerticalAlignment    ( row+1,col,'middle' );
  panel.setWidget               ( login_inp,row++,col+1,1,1 );
  panel.setWidget               ( pwd_inp  ,row  ,col+1,1,1 );
  panel.setWidget               ( vis_btn  ,row  ,col+2,1,1 );
  ...
  */
  ...
  panel.setImage ( image_path('ccp4cloud_remote'), '300px','300px', 0,0,row,1 );
