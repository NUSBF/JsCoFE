 ...
 *  -----------------------------------------------------------------
 *
 *  **** Module  :  js-client/cofe.tree_storage.js
 *       ~~~~~~~~~
...
let icon_ext = {
  ...
  'hkl'       : 'file_dummy',    // create and replace for file_hkl (images_png/file_phil.png)
  'hkl1'      : 'file_dummy',    // create and replace for file_hkl1 (images_png/file_phil.png)
  'hkl2'      : 'file_dummy',    // create and replace for file_hkl2 (images_png/file_phil.png)
  'cell'      : 'file_dummy',    // create and replace for file_cell (images_png/file_phil.png)
};
