...
#node ./js-server/fe_proxy.js ./config/conf.remote.json &
node ./js-server/desktop.js ./config/conf.remote.json

#node ./js-server/desktop.js ./config/conf.desktop_71.json
