#
# -----------------------------------------------------
# Auto-MR from sequence, ligand fitting and refinement
# -----------------------------------------------------
# 25.11.2023
#
...
NAME     Auto-MR workflow
ONAME    amr_wflow 
TITLE    Auto-MR Workflow with ligand fitting
DESC     MrBump followed by water/ligand fitting and refinement 
ICON     Gold  # added automatically
KEYWORDS auto MR workflow ligand  # for using in A-Z keyword search
...
# PAR_COMBO textComboInout
#     LABEL     Choose one option:
#     TOOLTIP   This is test combox parameter input
#     OPTION    A Option A 
#     OPTION    B Option B 
#     OPTION    C Option C 
#     DEFAULT   B
